...
import com.pilidili.dao.VideoDao;
import com.pilidili.domain.*;
import com.pilidili.domain.exception.ConditionException;
import com.pilidili.service.util.FastDFSUtil;
import com.pilidili.service.util.ImageUtil;
import com.pilidili.service.util.IpUtil;
...
public class VideoService {
    ...
    public void addVideoCoins(VideoCoin videoCoin, Long userId) {
        ...
        if(videoId == null){
            throw new ConditionException("parameters invalid！");
        }
        Video video = videoDao.getVideoById(videoId);
        if(video == null){
            throw new ConditionException("invalid video！");
        ...
        if(amount > userCoinsAmount){
            throw new ConditionException("unenough coins！");
        }
    ...
    public void addVideoComment(VideoComment videoComment, Long userId) {
        ...
        if(videoId == null){
            throw new ConditionException("invalid parameters！");
        }
        Video video = videoDao.getVideoById(videoId);
        if(video == null){
            throw new ConditionException("非法视频！");
...
//        System.out.println(similarity.userSimilarity(11, 12));
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.pilidili.domain.File file = fileService.getFileByMd5(fileMd5);
